...
output_csv = '../data/stats/wilcoxon_dispersion-diff_second.csv'
...
print(df[df['Participant'] == 'enriched'][measures].describe())
print(df[df['Participant'] == 'simplified'][measures].describe())
